...
Blockly.JavaScript.vars_global = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = 'inicioVariablesGlobales\n' + statements_variables + 'finVariablesGlobales\n';
  return code;
};

Blockly.JavaScript.vars_local = function(block) {
  var statements_variables = Blockly.JavaScript.statementToCode(block, 'variables');
  // TODO: Assemble JavaScript into code variable.
  var code = 'inicioVariablesLocales\n' + statements_variables + 'finVariablesLocales\n';
  return code;
};
...
Blockly.JavaScript.var_declaration = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = dropdown_var_type + ' ' + text_name + '\n';
  return code;
};
...
Blockly.JavaScript.string_append = function(block) {
  var text_string = block.getFieldValue('string');
  var value_sstring = Blockly.JavaScript.valueToCode(block, 'Sstring', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = '\"' + text_string + '\"';
  if(value_sstring != "")
   code += ', ' + value_sstring;
...
Blockly.JavaScript.if = function(block) {
  var value_condition_if = Blockly.JavaScript.valueToCode(block, 'condition_if', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_statement_if = Blockly.JavaScript.statementToCode(block, 'statement_if');
  // TODO: Assemble JavaScript into code variable.
  var code = 'inicioSi ' + value_condition_if + '\n' + statements_statement_if + 'finSi\n';
  return code;
...
Blockly.JavaScript.if_else = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = 'inicioSi ' + value_condition_if + '\n' + statements_statement_if + 'sino ' + '\n' + statements_statement_else + 'finSi\n';
  return code;
};

Blockly.JavaScript.if_elseif_else = function(block) {
  var value_condition_if = Blockly.JavaScript.valueToCode(block, 'condition_if', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_statement_if = Blockly.JavaScript.statementToCode(block, 'statement_if');
  var value_condition_elseif = Blockly.JavaScript.valueToCode(block, 'condition_elseif', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_statement_elseif = Blockly.JavaScript.statementToCode(block, 'statement_elseif');
  var statements_statement_else = Blockly.JavaScript.statementToCode(block, 'statement_else');
  // TODO: Assemble JavaScript into code variable.
  var code = 'inicioSi ' + value_condition_if + '\n' + statements_statement_if + 'sinoEsto ' + value_condition_elseif + '\n' + statements_statement_elseif + 'sino' +  '\n' + statements_statement_else + 'finSi\n';
  return code;
};

Blockly.JavaScript.expression = function(block) {
  var value_expression_left = Blockly.JavaScript.valueToCode(block, 'expression_left', Blockly.JavaScript.ORDER_ATOMIC);
  var dropdown_exp_type = block.getFieldValue('exp_type');
...
Blockly.JavaScript.expression_ao = function(block) {
  var value_expression_left = Blockly.JavaScript.valueToCode(block, 'expression_left', Blockly.JavaScript.ORDER_ATOMIC);
  var dropdown_exp_type = block.getFieldValue('exp_type');
  var value_expression_right = Blockly.JavaScript.valueToCode(block, 'expression_right', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript.assignation = function(block) {
  var value_assig_left = Blockly.JavaScript.valueToCode(block, 'assig_left', Blockly.JavaScript.ORDER_ATOMIC);
  var value_assig_right = Blockly.JavaScript.valueToCode(block, 'assig_right', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = value_assig_left + ' = ' + value_assig_right + '\n';
  return code;
};

Blockly.JavaScript.for = function(block) {
  var value_number_for = Blockly.JavaScript.valueToCode(block, 'number_for', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_statement = Blockly.JavaScript.statementToCode(block, 'statement');
  // TODO: Assemble JavaScript into code variable.
  var code = 'inicioRepetir ' + value_number_for + '\n' + statements_statement + 'finRepetir\n';
  return code;
  //return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript.while = function(block) {
  var value_bool_while = Blockly.JavaScript.valueToCode(block, 'bool_while', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_statement = Blockly.JavaScript.statementToCode(block, 'statement');
  // TODO: Assemble JavaScript into code variable.
  var code = 'inicioMientras ' + value_bool_while + '\n' + statements_statement + 'finMientras\n';
  return code;
};

Blockly.JavaScript.print = function(block) {
  var value_print_exp = Blockly.JavaScript.valueToCode(block, 'print_exp', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'imprimir ' + value_print_exp + '\n';
  return code;
};

Blockly.JavaScript.read = function(block) {
  var value_read_id = Blockly.JavaScript.valueToCode(block, 'read_id', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'leer ' + value_read_id + '\n';
  return code;
};

Blockly.JavaScript.function_def = function(block) { //definicion A
...
Blockly.JavaScript.call_func = function(block) {
  var text_name = block.getFieldValue('name');
  var value_definition = Blockly.JavaScript.valueToCode(block, 'definition', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'llamarFuncion ' + text_name + ' ' + value_definition + '\n';
  return code;
};

Blockly.JavaScript.call_func_assign = function(block) {
  var text_name = block.getFieldValue('name');
  var value_definition = Blockly.JavaScript.valueToCode(block, 'definition', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'llamarFuncion ' + text_name + ' ' + value_definition;
...
/*
Blockly.JavaScript.param_var = function(block) {
  var dropdown_func_type = block.getFieldValue('func_type');
  var text_name = block.getFieldValue('name');
  var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  if(value_name != "")
    var code = dropdown_func_type + ' ' + text_name + ' xxx ' + value_name;
  else {
      var code = dropdown_func_type + ' ' + text_name;
  }
  // TODO: Change ORDER_NONE to the correct strength.
  return code;
  //return [code, Blockly.JavaScript.ORDER_NONE];
...
Blockly.JavaScript.param_var = function(block) {
  ...
  var value_next_var = Blockly.JavaScript.valueToCode(block, 'next_var', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = dropdown_func_type + ' ' + text_name_var;
  if(value_next_var != "")
    code += ', ' + value_next_var;
  // TODO: Change ORDER_NONE to the correct strength.
  //return code;
...
//cuidado con este, int no lo estoy usando
/*
...
Blockly.JavaScript.param_call_var = function(block) {
  var text_variable = block.getFieldValue('variable');
  var value_call_var = Blockly.JavaScript.valueToCode(block, 'call_var', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = text_variable;
  if(value_call_var != "")
    code += ', ' + value_call_var;
...
Blockly.JavaScript.coma = function(block) {
  var value_coma = Blockly.JavaScript.valueToCode(block, 'coma', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = ' , ';
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
