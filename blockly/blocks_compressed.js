...
Blockly.Blocks.colour_picker={init:function(){
  this.jsonInit({message0:"%1",args0:[{type:"field_colour",name:"COLOUR",colour:"#ff0000"}],output:"Colour",colour:Blockly.Blocks.colour.HUE,helpUrl:Blockly.Msg.COLOUR_PICKER_HELPURL});var a=this;
  this.setTooltip(function(){var b=a.getParent();return b&&b.tooltip||Blockly.Msg.COLOUR_PICKER_TOOLTIP})}};

Blockly.Blocks.colour_random={init:function(){
  this.jsonInit({message0:Blockly.Msg.COLOUR_RANDOM_TITLE,output:"Colour",colour:Blockly.Blocks.colour.HUE,tooltip:Blockly.Msg.COLOUR_RANDOM_TOOLTIP,helpUrl:Blockly.Msg.COLOUR_RANDOM_HELPURL})}};
...
Blockly.Blocks.colour_blend={init:function(){
  ...
  this.appendValueInput("COLOUR2").setCheck("Colour").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.COLOUR_BLEND_COLOUR2);this.appendValueInput("RATIO").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.COLOUR_BLEND_RATIO);
  this.setOutput(!0,"Colour");this.setTooltip(Blockly.Msg.COLOUR_BLEND_TOOLTIP)}};Blockly.Blocks.lists={};Blockly.Blocks.lists.HUE=260;Blockly.Blocks.lists_create_empty={init:function(){
  this.jsonInit({message0:Blockly.Msg.LISTS_CREATE_EMPTY_TITLE,output:"Array",colour:Blockly.Blocks.lists.HUE,tooltip:Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP,helpUrl:Blockly.Msg.LISTS_CREATE_EMPTY_HELPURL})}};

Blockly.Blocks.lists_create_with={init:function(){this.setHelpUrl(Blockly.Msg.LISTS_CREATE_WITH_HELPURL);this.setColour(Blockly.Blocks.lists.HUE);
  this.itemCount_=3;this.updateShape_();this.setOutput(!0,"Array");
  this.setMutator(new Blockly.Mutator(["lists_create_with_item"]));
  this.setTooltip(Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP)},mutationToDom:function(){var a=document.createElement("mutation");a.setAttribute("items",this.itemCount_);return a},domToMutation:function(a){this.itemCount_=parseInt(a.getAttribute("items"),10);
  this.updateShape_()},decompose:function(a){var b=a.newBlock("lists_create_with_container");b.initSvg();for(var c=b.getInput("STACK").connection,d=0;d<this.itemCount_;d++){var e=a.newBlock("lists_create_with_item");e.initSvg();c.connect(e.previousConnection);c=e.nextConnection}return b},compose:function(a){var b=a.getInputTargetBlock("STACK");for(a=[];b;)a.push(b.valueConnection_),b=b.nextConnection&&b.nextConnection.targetBlock();for(b=0;b<this.itemCount_;b++){var c=this.getInput("ADD"+b).connection.targetConnection;
  c&&-1==a.indexOf(c)&&c.disconnect()}this.itemCount_=a.length;this.updateShape_();for(b=0;b<this.itemCount_;b++)Blockly.Mutator.reconnect(a[b],this,"ADD"+b)},saveConnections:function(a){a=a.getInputTargetBlock("STACK");for(var b=0;a;){var c=this.getInput("ADD"+b);a.valueConnection_=c&&c.connection.targetConnection;b++;a=a.nextConnection&&a.nextConnection.targetBlock()}},updateShape_:function(){this.itemCount_&&this.getInput("EMPTY")?this.removeInput("EMPTY"):this.itemCount_||this.getInput("EMPTY")||
  this.appendDummyInput("EMPTY").appendField(Blockly.Msg.LISTS_CREATE_EMPTY_TITLE);for(var a=0;a<this.itemCount_;a++)if(!this.getInput("ADD"+a)){var b=this.appendValueInput("ADD"+a);0==a&&b.appendField(Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH)}for(;
  this.getInput("ADD"+a);)
...
Blockly.Blocks.lists_create_with_container={init:function(){
  ...
  this.appendStatementInput("STACK");this.setTooltip(Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP);
  this.contextMenu=!1}};
...
Blockly.Blocks.math_modulo={init:function(){
  this.jsonInit({message0:Blockly.Msg.MATH_MODULO_TITLE,args0:[{type:"input_value",name:"DIVIDEND",check:"Number"},{type:"input_value",name:"DIVISOR",check:"Number"}],inputsInline:!0,output:"Number",colour:Blockly.Blocks.math.HUE,tooltip:Blockly.Msg.MATH_MODULO_TOOLTIP,helpUrl:Blockly.Msg.MATH_MODULO_HELPURL})}};

Blockly.Blocks.math_constrain={init:function(){
  this.jsonInit({message0:Blockly.Msg.MATH_CONSTRAIN_TITLE,args0:[{type:"input_value",name:"VALUE",check:"Number"},{type:"input_value",name:"LOW",check:"Number"},{type:"input_value",name:"HIGH",check:"Number"}],inputsInline:!0,output:"Number",colour:Blockly.Blocks.math.HUE,tooltip:Blockly.Msg.MATH_CONSTRAIN_TOOLTIP,helpUrl:Blockly.Msg.MATH_CONSTRAIN_HELPURL})}};

Blockly.Blocks.math_random_int={init:function(){
  this.jsonInit({message0:Blockly.Msg.MATH_RANDOM_INT_TITLE,args0:[{type:"input_value",name:"FROM",check:"Number"},{type:"input_value",name:"TO",check:"Number"}],inputsInline:!0,output:"Number",colour:Blockly.Blocks.math.HUE,tooltip:Blockly.Msg.MATH_RANDOM_INT_TOOLTIP,helpUrl:Blockly.Msg.MATH_RANDOM_INT_HELPURL})}};

Blockly.Blocks.math_random_float={init:function(){
  this.jsonInit({message0:Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM,output:"Number",colour:Blockly.Blocks.math.HUE,tooltip:Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP,helpUrl:Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL})}};Blockly.Blocks.procedures={};Blockly.Blocks.procedures.HUE=290;

Blockly.Blocks.procedures_defnoreturn={  init:function(){
  var a=new Blockly.FieldTextInput(Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE,Blockly.Procedures.rename);a.setSpellcheck(!1);
    this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE).appendField(a,"NAME").appendField("","PARAMS");
    this.setMutator(new Blockly.Mutator(["procedures_mutatorarg"]));Blockly.Msg.PROCEDURES_DEFNORETURN_COMMENT&&this.setCommentText(Blockly.Msg.PROCEDURES_DEFNORETURN_COMMENT);
    this.setColour(Blockly.Blocks.procedures.HUE);
    this.setTooltip(Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP);
    this.setHelpUrl(Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL);this.arguments_=[];
    this.setStatements_(!0);this.statementConnection_=null},validate:function(){var a=Blockly.Procedures.findLegalName(this.getFieldValue("NAME"),this);
    this.setFieldValue(a,"NAME")},setStatements_:function(a){this.hasStatements_!==a&&(a?(this.appendStatementInput("STACK").appendField(Blockly.Msg.PROCEDURES_DEFNORETURN_DO),this.getInput("RETURN")&&this.moveInputBefore("STACK",
...
Blockly.Blocks.vars_local = { //segmento donde declaras variables locales
  init: function() {
    this.appendDummyInput()
        .appendField("variables locales");
    this.appendStatementInput("variables")
        .setCheck('var');//este importa
    this.appendDummyInput()
        .appendField("fin variables globales");
    this.setPreviousStatement(true, 'mainFunc');
    this.setNextStatement(true, 'mainFunc');
    this.setColour(70);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#9968va');
  }
};

Blockly.Blocks.var_declaration = { //declaracion de variables
  init: function() {
    this.appendDummyInput()
        .appendField("var")
...
Blockly.Blocks.variable = {
  init: function() {
    ...
    this.setOutput(true, 'unaVariable');
    this.setColour(0);
    this.setTooltip('');
...
Blockly.Blocks.string = {
  init: function() {
    this.appendDummyInput()
        .appendField("\"")
        .appendField(new Blockly.FieldTextInput("texto"), "string")
        .appendField("\"");
    this.setOutput(true, 'string');
    this.setColour(5);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#7ij363');
  }
};

Blockly.Blocks.string_append = {
  init: function() {
    this.appendValueInput("Sstring")
        .setCheck(null)
        .appendField("\"")
        .appendField(new Blockly.FieldTextInput("texto"), "string")
        .appendField("\"");
...
Blockly.Blocks.if = { //if
  init: function() {
    ...
    this.appendStatementInput("statement_if")
        .setCheck('mainFunc');//todo puede ir adentro
    this.appendDummyInput()
        .appendField("fin");
    ...
    this.setColour(210);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#uw533w');
  }
};

Blockly.Blocks.if_else = { //if else
  init: function() {
    this.appendDummyInput()
        .appendField("si");
    this.appendValueInput("condition_if")
    ...
    this.setColour(210);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#5vvwkh');
  }
};

Blockly.Blocks.if_elseif_else = { //if elseif else
  init: function() {
    this.appendDummyInput()
        .appendField("si");
    this.appendValueInput("condition_if")
    ...
    this.appendStatementInput("statement_if")
        .setCheck('mainFunc');
    this.appendDummyInput()
        .appendField("sino esto");
    this.appendValueInput("condition_elseif")
        .setCheck(['Boolean', 'unaVariable']);
    this.appendDummyInput()
        .appendField("entonces");
    this.appendStatementInput("statement_elseif")
        .setCheck('mainFunc');
    this.appendDummyInput()
        .appendField("sino");
    this.appendStatementInput("statement_else")
    ...
    this.setColour(210);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#v8iep5');
  }
};
...
Blockly.Blocks.expression = { //< > <= >= != ==
  init: function() {
    ...
    this.setColour(210);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#q9crb5');
  }
};

Blockly.Blocks.expression_ao = { // and or
  init: function() {
    this.appendValueInput("expression_left")
        .setCheck(['Boolean', 'unaVariable']);
    this.appendDummyInput()
    ...
    this.setColour(210);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#cnuek5');
  }
};
...
Blockly.Blocks.boolean = { //true false
  init: function() {
    ...
    this.setColour(210);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#5bzghs');
  }
};
...
Blockly.Blocks.assignation = { // x = 0
  init: function() {
    this.appendValueInput("assig_left")
        .setCheck('unaVariable');
    this.appendDummyInput()
        .appendField("=");
    this.appendValueInput("assig_right")
        .setCheck(null);
    this.setInputsInline(true);
    this.setPreviousStatement(true, 'mainFunc');
    this.setNextStatement(true, 'mainFunc');
    this.setColour(240);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#k5ugng');
  }
};
...
Blockly.Blocks.for = {
  init: function() {
    this.appendDummyInput()
        .appendField("repetir");
    this.appendValueInput("number_for")
        .setCheck(['Number', 'unaVariable']);
    this.appendDummyInput()
        .appendField("veces");
    ...
    this.setColour(315);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#9ycemp');
  }
};
...
Blockly.Blocks.while = {
  init: function() {
    ...
    this.appendValueInput("bool_while")
        .setCheck(['Boolean', 'unaVariable']);
    this.appendDummyInput()
        .appendField("hacer");
    this.appendStatementInput("statement")
    ...
    this.setColour(315);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#24wt4m');
  }
};
...
Blockly.Blocks.print = {
  init: function() {
    ...
    this.appendValueInput("print_exp")
        .setCheck(null);
    this.setInputsInline(true);
    this.setPreviousStatement(true, 'mainFunc');
    this.setNextStatement(true, 'mainFunc');
    this.setColour(180);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#n2bdk8');
  }
};
...
Blockly.Blocks.read = {
  init: function() {
    ...
    this.setColour(180);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#er9xs5');
  }
};
...
Blockly.Blocks.call_func = {
  init: function() {
    this.appendValueInput("definition")
        .setCheck(['unaVariable', 'muchasVariables'])
        .appendField("llamar funcion")
        .appendField(new Blockly.FieldTextInput("nombre"), "name")
        .appendField("parametros");
    this.setInputsInline(false);
    this.setPreviousStatement(true, 'mainFunc');
    ...
    this.setColour(15);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#pf9swf');
  }
};

Blockly.Blocks.call_func_assign = {
  init: function() {
    this.appendValueInput("definition")
        .setCheck(['unaVariable', 'muchasVariables'])
        .appendField("llamar funcion")
    ...
    this.setColour(15);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#ojqjfc');
  }
};

Blockly.Blocks.param_var = {
  init: function() {
    ...
    this.setColour(15);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#z5ng9r');
  }
};
/*
Blockly.Blocks.param_int = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([["entero", "integer"], ["flotante", "float"], ["string", "string"], ["boolean", "boolean"], ["hash", "hash"]]), "type");
    this.setOutput(true, null);
    this.setColour(15);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#fmxyd6');
  }
};*/

Blockly.Blocks.param_call_var = {
  init: function() {
    this.appendValueInput("call_var")
        .setCheck(null)
        .appendField(new Blockly.FieldTextInput("variable"), "variable");
    this.setInputsInline(false);
    this.setOutput(true, 'muchasVariables');
    this.setColour(15);
    this.setTooltip('');
    this.setHelpUrl('https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#czuwkn');
  }
};

Blockly.Blocks.coma = {
  init: function() {
    this.appendValueInput("coma")
        .setCheck(null)
        .appendField(",");
    this.setInputsInline(false);
    this.setOutput(true, null);
